  ...
  <div id="container" className="col-lg-3 alert alert-light container">
    ...
    <div className="row">
      ...
      <div id="lefttop" className="col-sm border-right border-bottom border-secondary text-center">
        ...
        <br />
        <p className="h4 text-dark font-weight-bold">{(sample.reduce((elem, i) => elem + i.Offense.Passing, 0) / sample.length).toFixed(2)}</p>
      </div>

      <div id="righttop" className="col-sm border-bottom border-secondary text-center">
        <p id="headingComp">Rushing:</p>
        <br />
        <p className="h4 text-dark font-weight-bold">{(sample.reduce((elem, i) => elem + i.Offense.Rushing, 0) / sample.length).toFixed(2)}</p>
      </div>
    ...
    <div className="row">
      ...
      <div id="leftbottom" className="col-sm border-right border-bottom border-secondary text-center">
        ...
        <br />
        <p className="h4 text-dark font-weight-bold">{(sample.reduce((elem, i) => elem + i.Defense.Tackles, 0) / sample.length).toFixed(2)}</p>
      </div>

      <div id="rightbottom" className="col-sm border-bottom border-secondary text-center">
        <p id="headingComp">Interceptions:</p>
        <br />
        <p className="h4 text-dark font-weight-bold">{(sample.reduce((elem, i) => elem + i.Defense.Interceptions, 0) / sample.length).toFixed(2)}</p>
      </div>
